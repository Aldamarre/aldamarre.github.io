new (function () {
      ...
      case "object":
        ...
        if (p(b)) {
          ...
          for (var e = "", g = 0; g < d; g++)
            c.push(e),
              (e = b[g]),
              qa(a, a.Ua ? a.Ua.call(b, String(g), e) : e, c),
              (e = ",");
          c.push("]");
          break;
        }
  ...
  function Ha(a, b) {
    for (
      ...
      do {
        ...
        c =
          Ia(
            0 == oa[1].length ? 0 : parseInt(oa[1], 10),
            0 == pa[1].length ? 0 : parseInt(pa[1], 10)
          ) ||
          Ia(0 == oa[2].length, 0 == pa[2].length) ||
          Ia(oa[2], pa[2]);
      } while (0 == c);
    }
    return c;
  ...
  function ob(a, b) {
    ...
    if (1 < c) {
      ...
      a instanceof ob ? ((c = a.U()), (d = a.N())) : ((c = Wa(a)), (d = Va(a)));
  ...
  f.N = function () {
    pb(this);
    for (var a = [], b = 0; b < this.j.length; b++) a.push(this.u[this.j[b]]);
    return a;
  };
  f.U = function () {
    pb(this);
  ...
  f.remove = function (a) {
    return qb(this.u, a)
      ? (delete this.u[a], this.k--, this.j.length > 2 * this.k && pb(this), !0)
      : !1;
  };
  function pb(a) {
    if (a.k != a.j.length) {
    ...
    if (a.k != a.j.length) {
      for (var e = {}, c = (b = 0); b < a.j.length; )
        (d = a.j[b]), qb(e, d) || ((a.j[c++] = d), (e[d] = 1)), b++;
      a.j.length = c;
    }
  }
  f.get = function (a, b) {
  ...
  f.log = function (a, b, c) {
    if (a.value >= Cb(this).value)
      for (
        ...
        b = c;
        var d = a;
        if (b.ya) for (var e = 0, g = void 0; (g = b.ya[e]); e++) g(d);
        c = c.getParent();
      }
  };
  f.info = function (a, b) {
  ...
  H.prototype.add = function (a, b, c, d, e) {
    ...
    -1 < h
      ? ((b = a[h]), c || (b.Ha = !1))
      : ((b = new Lb(b, this.src, g, !!d, e)), (b.Ha = c), a.push(b));
    return b;
  };
  H.prototype.remove = function (a, b, c, d) {
    ...
    return -1 < b
      ? (Mb(e[b]),
        v.splice.call(e, b, 1),
        0 == e.length && (delete this.n[a], this.Ea--),
        !0)
      : !1;
  };
  function Ob(a, b) {
  ...
  function Nb(a, b, c, d) {
    for (var e = 0; e < a.length; ++e) {
      var g = a[e];
      if (!g.ma && g.da == b && g.Ia == !!c && g.La == d) return e;
    }
    return -1;
  }
  function I(a, b) {
  ...
  function cc(a, b, c, d, e) {
    if (p(b)) for (var g = 0; g < b.length; g++) cc(a, b[g], c, d, e);
    else
      (c = Yb(c)),
        a && a[Jb]
          ? a.zb(b, c, d, e)
          : a && (a = Zb(a)) && (b = a.xa(b, c, !!d, e)) && dc(b);
  }
  function dc(a) {
    ...
    Xb--;
    (c = Zb(b))
      ? (Ob(c, a), 0 == c.Ea && ((c.src = null), (b[Vb] = null)))
      : Mb(a);
    return !0;
  }
  function ac(a) {
    ...
    if (!Rb) {
      ...
      if (!(0 > e.keyCode || void 0 != e.returnValue)) {
        ...
        for (k = 0; !c.ga && k < e.length; k++)
          (c.currentTarget = e[k]), (x = ec(e[k], g, !1, c)), (d = d && x);
      }
      return d;
    }
  ...
  f.dispatchEvent = function (a) {
    ...
    if (b)
      for (var h = b.length - 1; !a.ga && 0 <= h; h--)
        (g = a.currentTarget = b[h]), (e = hc(g, d, !0, a) && e);
    a.ga ||
      ((g = a.currentTarget = c),
      (e = hc(g, d, !0, a) && e),
      a.ga || (e = hc(g, d, !1, a) && e));
    if (b)
      for (h = 0; !a.ga && h < b.length; h++)
        (g = a.currentTarget = b[h]), (e = hc(g, d, !1, a) && e);
    return e;
  };
  f.m = function () {
    L.C.m.call(this);
  ...
  f.td = function (a) {
    ...
    if (a.data) {
      ...
      try {
        ...
        M.d && console.log("Chatango: unexpected msg:" + a.data);
        return;
      }
      (this.sa && this.wa != b.fid) ||
        ((a = b.chatango_cmd) &&
          this.Db[a].apply(this, b.payload ? [b.payload] : []));
    }
  };
  ...
  f.Vd = function () {
    if (!this.sa) {
      ...
      M.d &&
        this.c.info("syn received, sending cid " + this.ra + " to a child");
      this.send("cid", a);
    }
  };
  f.Kc = function () {
  ...
  f.Gc = function (a) {
    ...
    a == this.wa &&
      (M.d && this.c.info("connection established for cid " + this.wa),
      (this.sa = !0),
  ...
  f.Od = function (a) {
    M.d && this.c.info("setTitle received " + rb(a));
    if (window.hasOwnProperty("onMessage"))
      window.onMessage(a.user + " " + a.time + ": " + a.msg, !0);
  };
  f.Ud = function () {
    M.d && this.c.info("stopTitle received");
    window.hasOwnProperty("stopTitleScrolling") &&
      window.stopTitleScrolling(new Event("stop_tile"));
  };
  f.Nd = function (a) {
  ...
  function Ic(a, b, c) {
    ...
    b instanceof Kc
      ? ((a.B = b), a.B.yb(a.v))
      : (c || (b = Lc(b, Qc)), (a.B = new Kc(b, 0, a.v)));
  }
  function Q(a) {
    if (a.bd) throw Error("Tried to modify a read-only Uri");
  }
  f.yb = function (a) {
    this.v = a;
    this.B && this.B.yb(a);
  ...
  f.remove = function (a) {
    ...
    a = Sc(this, a);
    return this.g.ta(a)
      ? ((this.s = null), (this.k -= this.g.get(a).length), this.g.remove(a))
      : !1;
  };
  f.clear = function () {
    this.g = this.s = null;
  ...
  f.toString = function () {
    ...
    for (var a = [], b = this.g.U(), c = 0; c < b.length; c++)
      for (
        var d = b[c], e = encodeURIComponent(String(d)), d = this.N(d), g = 0;
        g < d.length;
        g++
      ) {
        var h = e;
  ...
  function Tc(a) {
    ...
    2 <= b.length &&
      "com" == b[0] &&
      "chattanga" == b[1] &&
      (a = 3 <= b.length && "dev2" == b[2] ? Vc : Wc);
    M.d && "file:" == this.Sa && (a = Xc);
    a == Uc
      ? (this.qa = "chatango.com")
      : a == Wc
      ? ((this.qa = "chattanga.com"), (this.fa = Yc))
      : a == Vc
      ? (this.qa = zc)
      : M.d && a == Xc && (this.qa = zc);
  }
  ...
  function nd(a) {
    ...
    return z && C("10") && a.pageYOffset != b.scrollTop
      ? new T(b.scrollLeft, b.scrollTop)
      : new T(a.pageXOffset || b.scrollLeft, a.pageYOffset || b.scrollTop);
  }
  function U(a, b, c) {
    var d = arguments,
      e = document,
  ...
  function od(a, b, c, d) {
    ...
    for (; d < c.length; d++) {
      var g = c[d];
      !da(g) || (fa(g) && 0 < g.nodeType) ? e(g) : Oa(pd(g) ? Ta(g) : g, e);
    }
  }
  function qd(a, b) {
  ...
  f.X = null;
  f.t = function () {
    return this.X ? this.X.clone() : null;
  };
  f.m = function () {
    zd.C.m.call(this);
  ...
  f.Xc = function () {
    ...
    a == b ||
      ...
      ((this.X = a), this.dispatchEvent("resize"));
  };
  function Ad() {
    this.Fc = new zd();
  }
      ...
      if (a >= this.Lb) {
        ...
        for (i = a - this.Lb; i < a; i++)
          if (
            !(
              0 >= i ||
              (this.I[i].ow == this.I[i - 1].ow &&
                this.I[i].iw == this.I[i - 1].iw &&
                this.I[i].ih == this.I[i - 1].ih)
            )
          ) {
            b = !1;
            break;
        ...
        if (b) {
          ...
          if (b !== this.ec || this.tb)
            (this.ec = b), (this.Aa = a), this.dispatchEvent(new I("c"));
          else {
            if (this.cb && Math.abs(a - this.Aa) > 0.25 * this.Aa) {
              var b = Bd.i(),
                c = a < this.Aa;
              c !== b.rb &&
                ((b.rb = c)
  ...
  Vd.prototype.fb = [
    ...
    },
    {
      ...
      rules: [
        ...
        { platform: "ANDROID", lessThan: 4, platform: ["NOT_GECKO"] },
      ],
    },
    {
  ...
  function Wd(a, b, c) {
    ...
    for (b = 0; b < a.fb.length; b++)
      for (c = a.fb[b].type, d = a.fb[b].rules, e = 0; e < d.length; e++)
        if (
          ((g = d[e]),
          M.d && a.c.info("Testing rule: " + na(g)),
  ...
  function Xd(a, b) {
    ...
    if ("undefined" != typeof b.platform)
      if ("IE" == b.platform) {
        ...
        if (!c || !c.match(/\b(iOS|iPod|iPad|iPhone)\b/)) return !1;
      } else if (!("ANDROID" != b.platform || (c && Sd))) return !1;
    M.d && a.c.info("Checking rule version");
    if ("ANDROID" == b.platform) {
      if (
        ("undefined" != typeof b.lessThan && Td(b.lessThan)) ||
        ("undefined" != typeof b.atLeast && !Td(b.atLeast))
      )
        return !1;
    } else if (
    ...
    if (
      ...
      (M.d &&
        (a.c.info('uri.getParameterValue(rule["param"]): ' + d.B.get(b.param)),
        a.c.info(
          'typeof uri.getParameterValue(rule["param"]): ' +
            typeof d.B.get(b.param)
        )),
      "undefined" === typeof d.B.get(b.param) && (!a.rc || a.rc != b.param))
    )
      return !1;
    M.d && a.c.info("Checking rule parameters");
      ...
      if (a.J)
        switch (b.styles) {
          case "jsr":
            ...
            break;
          case "is_cv":
            if (!((a.J.cv && 0 != a.J.cv) || (a.J.pos && "none" != a.J.pos)))
              return !1;
        }
      else return !1;
  ...
  u(be, Yd);
  function ce(a) {
    return (a = $d(a)) ? new ActiveXObject(a) : new XMLHttpRequest();
  }
  function $d(a) {
    if (
      !a.ac &&
      ...
      for (
        ...
        var d = b[c];
        try {
          return new ActiveXObject(d), (a.ac = d);
        } catch (e) {}
      }
      throw Error(
    ...
    try {
      ke(this),
        0 < this.Da &&
          ...
          this.$a
            ? ((this.b.timeout = this.Da),
              (this.b.ontimeout = t(this.Ec, this)))
            : (this.Za = Rd(this.Ec, this.Da, this))),
        X(this.A, Y(this, "Sending request")),
        (this.Na = !0),
        this.b.send(a),
        (this.Na = !1);
    } catch (h) {
      X(this.A, Y(this, "Send error: " + h.message)), je(this, h);
    }
  };
  function le(a) {
  ...
  f.gb = function () {
    return this.bb ? ce(this.bb) : ce(ae);
  };
  f.Ec = function () {
    "undefined" != typeof aa &&
      this.b &&
      ((this.za = "Timed out after " + this.Da + "ms, aborting"),
      X(this.A, Y(this, this.za)),
  ...
  f.m = function () {
    this.b &&
      (this.l &&
        ((this.l = !1), (this.aa = !0), this.b.abort(), (this.aa = !1)),
      this.ja(!0));
    de.C.m.call(this);
  };
  f.oc = function () {
    this.Y || (this.pb || this.Na || this.aa ? ne(this) : this.wd());
  };
  f.wd = function () {
    ne(this);
  };
  function ne(a) {
    if (a.l && "undefined" != typeof aa)
      if (a.ab[1] && 4 == Z(a) && 2 == oe(a))
        X(a.A, Y(a, "Local request error detected and ignored"));
        ...
        try {
          ...
          if (d) a.dispatchEvent("complete"), a.dispatchEvent("success");
            ...
            var k;
            try {
              k = 2 < Z(a) ? a.b.statusText : "";
            } catch (x) {
              X(a.A, "Can not get status: " + x.message), (k = "");
            }
            a.za = k + " [" + oe(a) + "]";
            me(a);
          }
  ...
  f.getResponseHeader = function (a) {
    return this.b && 4 == Z(this) ? this.b.getResponseHeader(a) : void 0;
  };
  f.getAllResponseHeaders = function () {
    return this.b && 4 == Z(this) ? this.b.getAllResponseHeaders() : "";
  };
  function Y(a, b) {
    return b + " [" + a.dc + " " + a.ba + " " + oe(a) + "]";
  }
  function pe() {
    L.call(this);
    this.q = null;
  ...
  f.send = function (a, b, c) {
    ...
    try {
      M.d && this.c.info("Opening Xdr"), this.q.open(b, a);
    } catch (g) {
    ...
    a = c || "";
    try {
      M.d && this.c.info("Sending request"), this.q.send(a);
    } catch (h) {
      this.c.log(yb, "Send error: " + h.message, void 0);
    }
  };
  f.sd = function () {
  ...
  f.abort = function () {
    this.q &&
      this.l &&
      (M.d && this.A.log(Bb, Y(this, "Aborting"), void 0),
      (this.l = !1),
      this.q.abort(),
      this.dispatchEvent("complete"),
      this.dispatchEvent("abort"),
  ...
  f.zb = function (a, b, c, d, e) {
    if (p(b)) for (var g = 0; g < b.length; g++) this.zb(a, b[g], c, d, e);
    else
  ...
  function we(a, b, c) {
    ...
    this.Y
      ? a.call(void 0)
      : (this.ea || (this.ea = []), this.ea.push(m(void 0) ? t(a, void 0) : a));
  ...
  function ye(a) {
    m(a.wc) || (a.wc = "rtl" == Ld(a.target, "direction"));
    return a.wc;
  }
  f.Ac = function (a) {
    ...
    if (
      ...
      this.Z ||
      (b &&
        (!(Qb ? 0 == a.M.button : "click" == a.type || a.M.button & Ub[0]) ||
          (B && db && a.ctrlKey)))
    )
      this.dispatchEvent("earlycancel");
    else {
      if (0 == this.$b)
        if (this.dispatchEvent(new ze("start", this, a.clientX, a.clientY, a)))
          (this.Z = !0), a.preventDefault();
        else return;
      ...
      xe
        ? (c.setCapture(!1), this.L.V(c, "losecapture", this.Ja))
        : this.L.V(
      ...
      this.Bb
        ? ((a = this.target),
          (b = a.offsetLeft),
          (c = a.offsetParent),
          c || "fixed" != Ld(a, "position") || (c = hd(a).documentElement),
          c
            ? (A
                ? ((d = Od(c)), (b += d.left))
  ...
  f.Wc = function (a) {
    if (this.Ub) {
      ...
      if (!this.Z) {
        ...
        if (d * d + e * e > this.$b)
          if (
            this.dispatchEvent(new ze("start", this, a.clientX, a.clientY, a))
          )
            this.Z = !0;
          else {
            this.Y || this.Ja(a);
      ...
      this.Z &&
        this.dispatchEvent(
          new ze("beforedrag", this, a.clientX, a.clientY, a, b, c)
        ) &&
        (De(this, a, b, c), a.preventDefault());
    }
  };
  function Ce(a, b, c) {
    var d;
  ...
  f.oa = null;
  f.stop = function () {
    this.oa && (l.clearTimeout(this.oa), (this.oa = null), (this.Ya = !1));
  };
  f.pause = function () {
    this.wb++;
  };
  ...
  Ge.prototype.Qc = function () {
    this.dispatchEvent(new Ed(this.Va));
  };
  function Ie(a, b, c) {
    var d,
      e,
  ...
  function He(a, b) {
    b ? W(a.a, "pointer-events", "auto") : W(a.a, "pointer-events", "none");
  }
  function Je() {
    L.call(this);
    this.Tb = "";
  ...
  function Ke() {
    ...
    vc() &&
      (this.Ga = document.documentElement.clientWidth / window.innerWidth);
    if ((this.p = Le())) {
      ...
      this.nb = !1;
      vc() &&
        this.f.styles.fwtickm &&
        0 != this.f.styles.fwtickm &&
        ((this.nb = !0),
        (this.f.styles.cv = 1),
        (a = new S(window.innerWidth, 0.075 * window.innerHeight)),
        (this.f.styles.cvw = a.width),
        (this.f.styles.cvh = a.height),
        (this.f.styles.ticker = 1),
        (this.f.styles.cvfntsz = "100%"),
        (a = "br"));
      this.o = a;
      ...
      "js" == c || "jsonly" == c
        ? ((this.ob = Ne(this, this.p, a)),
          (this.e = xc.i()),
          K(this.e, "resizeiframe", this.yd, !1, this),
          K(
            this.e,
            "browserviewrequest",
            function () {
              this.e.send("browserviewresponse", this.t());
            },
            !1,
            this
          ),
          K(this.e, "buttonexpanded", this.hd, !1, this),
          K(this.e, "buttoncollapsed", this.gd, !1, this),
          this.e.Ca(this.a.contentWindow, this.p.id, this.ob, this),
          K(this.e, "setuserscalable", this.Cd, !1, this),
          K(this.e, "viewporttoobig", this.Gd, !1, this),
          K(this.e, "settitle", this.Fd, !1, this),
          K(this.e, "connestablished", this.jd, !1, this),
          K(this.e, "enableresizedragger", this.pd, !1, this),
          K(this.e, "kbdown", this.mc, !1, this),
          K(this.e, "kbup", this.sb, !1, this))
        : "linkandroidchrome" == c
        ? Oe(this, this.p)
        : "linkandroidff" == c
        ? Pe(this, this.p)
        : "linkdesktopchrome" == c && Qe(this, this.p);
    }
  }
  n(Ke);
  var Re = /^cid\d{10,20}$/;
  ...
  f.pd = function (a) {
    ...
    b &&
      !this.Wa &&
      ((this.Wa = new Ge(this.a, this.f.styles.pos)),
      K(this.Wa, Fd, this.xd, !1, this));
    if (this.Wa)
      if (((a = this.Wa), b))
        if (
          ((a.K.style.display = "block"),
          (b = localStorage.getItem(a.zc)),
          (b = JSON.parse(b)))
        ) {
          var c = Ad.i().Fc,
            b = new S(
              Math.min(b.w, c.t().width - 20),
              Math.min(b.h, c.t().height - 20)
            );
    ...
    switch (a.data) {
      case "disable":
        ...
        if (0 == b.length)
          ...
          this.P = b[b.length - 1];
          a = {};
          for (var c = this.P.attributes.length, b = 0; b < c; b++)
            a[this.P.attributes[b].nodeName] = this.P.attributes[b].nodeValue;
          if (a.content)
            if ((b = a.content.match(/user-scalable\s*=\s*([01yesnotrufal]*)/)))
              ...
              kd(this.P, { content: a.content + ", user-scalable=1" }),
                (a.content += ", user-scalable=0");
          else
            (a.content = "user-scalable=0"),
              (this.P.attributes.content = "user-scalable=1");
          this.S = U("META");
          kd(this.S, a);
          ud(this.S, this.P);
        }
  ...
  function Ne(a, b, c) {
    ...
    if (a.hb) {
      if (
        ((a.width = a.f.styles.cvw || 65),
        (a.height = a.f.styles.cvh || 20),
        e &&
          !a.O &&
          ((a.O = Bd.i()),
          K(a.O, "keyboardraised", a.sb, !1, a),
          K(a.O, "keyboardlowered", a.lc, !1, a)),
        e && !a.D)
      ) {
        a.D = V.i();
        K(a.D, "a", a.ld, !1, a);
        ...
        /ipad|ipod|iphone/gi.test(navigator.appVersion)
          ? K(document, "gestureend", g.pc, !1, g)
          : K(document, "touchend", g.pc, !1, g);
        d
          ? ((d = a.D), K(window, "resize", d.qc, !1, d))
          : ((d = a.D), K(window, "orientationchange", d.ud, !1, d));
      }
    } else
      d &&
        !a.D &&
    ...
    c
      ? (W(a.a, "z-index", 2147483648), Ue(a), sd(a.a))
      : xd(b)
      ? sd(a.a)
      : rd(a.a, b);
    ...
    a.Gb = {
      ...
      "exe.bz": !0,
      "getxid.com": !0,
      "izlemac-cbkws-com.cdn.ampproject.org": !0,
  ...
  f.Ad = function (a) {
    ...
    "r" + Dd.i().fc != "r" + a.r &&
      ...
      (this.a.src = "about:blank"),
      ud(this.a, b),
      this.f.styles.cv
        ? W(this.a, "display", "none")
        : this.a.contentDocument.write(
  ...
  f.nc = function () {
    this.nb
      ? ((this.Ga = -1), this.Pa())
      : this.e.send("orientation_change", this.t());
  };
  f.jd = function () {
    this.e.send("inittitle", document.title);
  };
  f.hd = function () {
    this.ia ||
      ((this.ia = U("div", {
  ...
  f.gd = function () {
    this.ia &&
      (W(this.ia, "display", "none"),
      this.e.disconnect(),
      (this.Vb = !1),
      td(this.a),
      rd(this.a, this.ia),
      this.e.Ca(this.a.contentWindow, this.p.id, this.ob, this),
      W(this.a, "position", "static"));
  };
  f.Cb = 0;
  f.Pa = function () {
    ...
    if (a != this.Ga) {
      ...
      this.o &&
        (this.nb &&
          ((c = new S(window.innerWidth, 0.075 * window.innerHeight)),
          (this.width = c.width),
          (this.height = c.height),
          (this.Cb = 1 < this.Ga ? 1 : 0),
          (b = c.width + 2 * this.Cb),
          (c = c.height),
          this.a.setAttribute("width", b + "px"),
          this.a.setAttribute("height", c + "px"),
          W(this.a, "width", b + "px"),
          W(this.a, "height", c + "px")),
        Ue(this));
      a = this.t();
  ...
  function Ue(a) {
    if (a.o)
      if (P.i().ua == uc || 1 >= a.Ga) {
        ...
        a.pa &&
          (cc(window, "scroll", a.Qa, !1, a),
          a.na && clearTimeout(a.na),
          W(a.a, "display", "block"),
          (a.qb = !1));
        a.pa = !1;
      } else
        (a.pa = !0),
          W(a.a, "position", "absolute"),
          K(window, "scroll", a.Qa, !1, a),
          Ve(a);
  }
  f.sb = function () {
    if (this.Uc) {
  ...
  f.lc = function () {
    -1 != navigator.userAgent.indexOf("Android") &&
      this.e &&
      this.e.send("keyboarddown");
    this.mc();
  };
  f.Ab = !1;
  function Ve(a) {
    a.Ab || ((a.Ab = !0), setTimeout(t(a.Xd, a), 100));
  }
  f.Xd = function () {
    this.Ab = !1;
  ...
  function We(a, b) {
    ...
    b && !c && a.ib && !a.qb
      ? (W(a.a, "transition", "opacity .3s ease-in"), W(a.a, "opacity", 1))
      : (W(a.a, "transition", "none"), W(a.a, "opacity", 0));
  }
  f.Qa = function () {
    if (this.pa) {
      this.qb = !0;
